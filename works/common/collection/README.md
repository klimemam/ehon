# Collection architecture / maps

短編集全体の順序、時系列、命名、予測、視覚を扱う入口。

## 現行の入口

| 文書 | 状態 | 責務 |
| --- | --- | --- |
| [`../kousei-rev1.md`](../kousei-rev1.md) | active proposal | `release-rev1` の構成案。release そのものではない |
| [`../map.md`](../map.md) | active map | 架空の本の目次と作品の対応 |
| [`../map-axes.md`](../map-axes.md) | active map | 分野・接地・温度・主体の多角評価 |
